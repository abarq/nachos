...
Thread::~Thread()
{
    ...
    openFilesTable->delThread();  //Cuando se elimina un hilo disminuye en uno usage;
...
Thread::Fork(VoidFunctionPtr func, void* arg)
{
    ...
    this->openFilesTable->addThread();  //Incrementa en uno el valor de usage cuando se crea un hilo empleando Fork().
}    
